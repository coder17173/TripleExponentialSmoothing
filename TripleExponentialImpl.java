package com.nust.predict.TripleExponentialSmoothing;

import java.util.ArrayList;
import java.util.List;

import com.nust.predict.utils.JCSVUtils;
...
//		}
	...
	public static void main(String[] args){
    	...
    	records = JCSVUtils.readeCsv("./data/tempreture.csv");
    	double[] real = new double[records.size()];
    	for(int i = 0; i < records.size(); i++){
    		real[i] = Double.valueOf(records.get(i)[0]);
    	}
    	double alpha = 0.1, beta = 0.45, gamma = 0;
    	int period = 365, m = 365;
    	boolean debug = false;
